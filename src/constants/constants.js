...
export const TimeLineData = [
  { year: 2013, text: '• Graduated from University of California, Irvine (UCI) - BS in Mechanical Engineering.', text2:"• Began professional Engineering career at GKN Aerospace." },
  { year: 2015, text: `• Started position at JE Pistons as an Application Design Engineer.` },
  { year: 2017, text: `• Promoted to Lead, Engineer at parent company Race Winning Brands, managing a team of 5 engineers.` },
  { year: 2021, text: `• Promoted to Lead, Engineer III, tackling projects focusing on expanding product lines, increasing revenue streams, and improving overall engineering processes.` },
  { year: 2022, text: '• Began Hack Reactor, a Full-Stack software development program with JavaScript, React, Express, PostgreSQL, MongoDB, and MySQL in an AGILE environment (1000+ hours of coding)', },
  { year: 2023, text: '• Graduated Hack Reactor.', }
];